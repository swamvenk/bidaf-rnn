...
# Preprocess data
python3 -m squad.prepro --mode single --single_path $source_path $parg --target_dir $inter_dir --glove_dir $glove_dir
...
python3 -m basic.cli --data_dir $inter_dir --eval_path $eval_path --nodump_answer --load_step 7000 $marg --eval_num_batches 0 --mode forward --batch_size 60 --len_opt --cluster --cpu_opt --load_ema
