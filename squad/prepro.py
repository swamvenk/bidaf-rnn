...
def prepro(args):
    ...
    if args.mode == 'full':
        ...
        prepro_each(args, 'test', out_name='dev')
...
def prepro_each(args, data_type, start_ratio=0.0, stop_ratio=1.0, out_name="default", in_path=None):
    ...
    source_path = in_path or os.path.join(args.source_dir, "{}{}.json".format(data_type, args.suffix))
    ...
    for ai, article in enumerate(tqdm(source_data[start_ai:stop_ai])):
        ...
        for pi, para in enumerate(article['paragraphs']):
            ...
            for qa in para['qas']:
                ...
                answers = []
                if len(qa['answer']) == 0:
                    qa['answer']={'text': "random", 'answer_start': 1}
